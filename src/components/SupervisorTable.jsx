      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
        <thead>
          <tr style={{ borderBottom: '1px solid var(--color-border-default)' }}>
            {['Barreno', 'Ubicación', 'Operador', 'Equipo', 'Voladura', 'Prof.', 'Turno', 'Hora', ''].map((h, i) => (
              <th key={i} style={{
                fontFamily: 'var(--font-mono)', fontSize: 10,
        ...
        <tbody>
          {tableRows.length === 0 ? (
            ...
            >
              ...
              <td style={{ padding: '10px 12px', color: 'var(--color-text-primary)', fontFamily: 'var(--font-mono)', fontSize: 12 }}>
                {r.location || '—'}
              </td>
