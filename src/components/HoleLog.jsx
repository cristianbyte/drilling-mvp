...
export default function HoleLog({
  ...
  const deleteRows = targetHole
    ? [
        ...
        { key: 'Ubicacion', val: shiftLocation || '-' },
        ...
        <div style={{ borderTop: '1px solid var(--color-border-subtle)' }}>
          {holes.length === 0 ? (
            ...
            [...holes].reverse().map((hole, index) => {
              ...
              const detailText = [ceilingText, floorText].filter(Boolean).join(' · ') || 'Sin T/P'
              ...
              return (
                ...
                >
                  ...
                  >
                    <ActionIconButton
                      title={isSynced ? 'Sincronizado' : 'Pendiente de sincronizacion'}
                      disabled
